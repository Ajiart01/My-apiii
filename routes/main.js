...
router.get('/bioku', (req, res) => {
    res.sendFile(__path + '/views/bio.html')
})
...
router.get('/apikey-not-found', (req, res) => {
    res.sendFile(__path + '/views/apikey-not-found.html')
})

router.get('/apikey-not-premium', (req, res) => {
    res.sendFile(__path + '/views//views/apikey-not-premium.html')
})
