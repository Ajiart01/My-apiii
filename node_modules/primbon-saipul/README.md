...
//Arti Nama
primbon.artiNama('saipul').then(res => {
    console.log(res)
})
...
//Nama Pasangan
primbon.Jodoh('saipul', 'manda').then(res => {
    console.log(res)
})
