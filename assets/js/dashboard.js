...
// Visitor
$.getJSON("https://api.countapi.xyz/hit/haryadin/visitor", function(response) {
    $("#visitors").text(response.value);
})

// User Login
$.getJSON("https://api.countapi.xyz/hit/haryadin/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/haryadin/requesttoday1", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/haryadin/totalrequest", function(response) {
